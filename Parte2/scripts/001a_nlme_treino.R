...
cod_teste <- paste(local_pasta, "scripts\\001b_nlme_teste.R", sep = "")
source(cod_teste)

#### 5.0 - Execução dos Arquivos de Teste ####
# neste ponto, este arquivo, executa os próximos automaticamente
# o gráfico de DPM não está sendo gerado de forma automatica

# cod_teste1 <- paste(local_pasta, "scripts\\001b_nlme_teste[01a21].R", sep = "")
# cod_teste2 <- paste(local_pasta, "scripts\\001c_nlme_teste[22a42].R", sep = "")
# cod_teste3 <- paste(local_pasta, "scripts\\001d_nlme_teste[43a63].R", sep = "")
# cod_teste3 <- paste(local_pasta, "scripts\\001e_nlme_teste[64a84].R", sep = "")
# cod_teste3 <- paste(local_pasta, "scripts\\001f_nlme_teste[85a105].R", sep = "")
