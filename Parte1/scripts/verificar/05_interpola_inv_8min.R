...
source("D:/github/Tabelas_DynamoDB/csv_para_analise/05_interpola_inv_7min.R")
source("D:/github/Tabelas_DynamoDB/csv_para_analise/05_interpola_inv_6min.R")
source("D:/github/Tabelas_DynamoDB/csv_para_analise/05_interpola_inv_5min.R")
source("D:/github/Tabelas_DynamoDB/csv_para_analise/05_interpola_inv_4min.R")
source("D:/github/Tabelas_DynamoDB/csv_para_analise/05_interpola_inv_3min.R")
source("D:/github/Tabelas_DynamoDB/csv_para_analise/05_interpola_inv_2min.R")



source("D:/github/Tabelas_DynamoDB/csv_para_analise/04_amostras_faltantes_inversor.R")
